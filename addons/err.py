...
class Err:
    ...
    errcodes = {
        ...
        '002-0102': 'System is permanently banned by Nintendo, they confirmed it! You cannot ask how to fix this issue here.',
        '002-0106': '? is banned by Nintendo, commonly caused by using too many IDs. You cannot ask how to fix this issue here.',
        '002-0107': '? is banned by Nintendo, commonly caused by using unsupported games online. You cannot ask how to fix this issue here.',
        '002-0109': '? is banned by Nintendo. You cannot ask how to fix this issue here.',
        ...
        '002-0123': 'Game Card is banned by Nintendo, this is probably caused by using illegal private header (or illegal copy of purchased game) and going online with it. You cannot ask how to fix this issue here.',
        ...
        '022-2801': 'NNID services banned on system.,'
        '022-2802': 'NNID is permanently banned from all services by Nintendo.',
        '022-2803': 'NNID is permanently banned from a unique game.',
        '022-2804': 'NNID is permanently from a unique game server.',
        '022-2805': 'NNID is permanently banned from Nintendo eShop, it was previously was also a bancode for Miiverse.',
        '022-2812': 'System is permanently banned from all online services.',
        '022-2813': 'System is permanently banned from unique game.',
        '022-2814': 'System is permanently banned from a unique game server.',
        '022-2815': 'System is permanently banned from Nintendo eShop. This was also a possible Miiverse system ban back then.,'
        '022-2822': 'NNID temporarily banned from all services.',
        '022-2823': 'NNID is temporarily banned from a unique game.',
        '022-2824': 'NNID is temporarily banned from a unique game server.',
        '022-2825': 'NNID is temporarily banned from Nintendo eShop, it was previously was also a bancode for Miiverse.',
        '022-2832': 'System is temporarily banned from all online services.',
        '022-2833': 'System is temporarily banned from a unique game.',
        '022-2834': 'System is temporarily banned from a unique game server.',
        '022-2835': 'System is temporarily banned from Nintendo eShop. This was also a possible Miiverse system ban back then.,
        ...
        '102-2803': 'NNID is permanently banned from unique game'.,
        '102-2804': 'NNID is permanently banned from unique game server'.,
        '102-2805': 'NNID is permanently banned from accessing Nintendo eShop, this previously could ban Nintendo TVii and Miiverse but now sinc ethey are done for, its just a Nintendo eShop ban. You cannot ask how to fix this issue here.',
        '102-2812': 'System + linked NNID and access to Nintendo Network services are permanently banned by Nintendo. You cannot ask how to fix this issue here.',
        '102-2813': 'System is permanently banned for a unique game. You cannot ask how to fix this issue here.',
        '102-2814': 'System is permanently banned from a unique game server (preferably Splatoon). You cannot ask how to fix this issue here.',
        '102-2815': 'System is permanently banned from accessing the Nintendo eShop. You cannot ask how to fix this issue here.',
        '102-2816': 'System is banned from a game for an unknown duration, by attempting to use modified static.pack/+ game files online. You cannot ask how to fix this issue here.',
        '102-2822': 'NNID + all network services are temporarily banned by Nintendo. You cannot ask how to fix this issue here.',
        '102-2823': 'System is temporarily banned from a unique game.',
        '102-2824': 'NNID is temporarily banned from unique game server'.,
        '102-2825': 'NNID is temporarily banned from accessing Nintendo eShop, this previously could ban Nintendo TVii and iiverse but now sinc ethey are done for, its just a Nintendo eShop ban. You cannot ask how to fix this issue here.',
        '102-2832': 'System + linked NNID is temporarily banned from all Nintendo Network services. You cannot ask how to fix this issue here.',
        '102-2833': 'System is temporarily banned for a unique game . You cannot ask how to fix this issue here.',
        '102-2834': 'System is temporarily banned from a unique game server (preferably Splatoon). You cannot ask how to fix this issue here.',
        '102-2835': 'System is temporarily banned from accessing the Nintendo eShop. You cannot ask how to fix this issue here.',
        '106-0306': 'NNID is temporarily banned from a unique game (preferably Splatoon). You cannot ask how to fix this issue here.',
        '106-0346': 'NNID is permanently banned from a unique game (preferably Splatoon). You cannot ask how to fix this issue here.',
    ...
    switch_errcodes = {
        ...
        '2124-4027': ['System + Nintendo Account are banned from a/multiple game(s) (preferably Splatoon 2) online multiplayer services for a set duration which can be found afte checking your email on the account recieving the ban. You cannot ask how to fix this issue here.', None],
